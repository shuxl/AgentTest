...
async def build_cardiology_knowledge_base():
    """构建心血管科知识库"""
    print("=" * 60)
    print("构建心血管科知识库")
    print("=" * 60)
    ...
    # 从目录批量导入文档
    doc_dir = Path(__file__).parent.parent / "data" / "medical_docs" / "cardiology"
    print(f"\n2. 从目录导入文档: {doc_dir}")
...
if __name__ == "__main__":
    asyncio.run(build_cardiology_knowledge_base())
