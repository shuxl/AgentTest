...
# 添加项目根目录到路径
project_root = Path(__file__).parent.parent.parent.parent  # tests/integration/rag_env_check/ -> tests/integration/ -> tests/ -> V2_0_Agent/
...
class RAGInfrastructureTest:
    ...
    async def run_all_tests(self):
        ...
        print("=" * 80)
        settings = get_settings()
        print(f"数据库URI: {settings.db_uri}")
