...
# 添加项目根目录到路径
project_root = Path(__file__).parent.parent.parent.parent  # tests/integration/rag/ -> tests/integration/ -> tests/ -> V2_0_Agent/
...
class RAGInfrastructureTests:
    ...
    def __init__(self):
        """初始化测试类"""
        self.test_results = []
        self.test_data_dir = project_root / "tests" / "integration" / "rag_env_check" / "test_data"
